...
func (c *compiler) assemble() []byte {
	...
	b.WriteString("\n")
	b.WriteString("\t\"github.com/avmnu-sng/quill-template-engine/pkg/compiled\"\n")
	b.WriteString("\tqerrors \"github.com/avmnu-sng/quill-template-engine/pkg/errors\"\n")
	b.WriteString("\t\"github.com/avmnu-sng/quill-template-engine/pkg/ext\"\n")
	b.WriteString("\t\"github.com/avmnu-sng/quill-template-engine/pkg/runtime\"\n")
	b.WriteString("\t\"github.com/avmnu-sng/quill-template-engine/pkg/source\"\n")
	b.WriteString(")\n\n")
